...
def new_entity(name, devtest=True, l3out_vlan=None):
    ...
    for network in networks:
        ...
        if svi_ip == 'None':
            bd = new_l2bd(tenant, bd_name, context)
        elif network['scope'] == 'public':
    ...
    bd_networks.append(dmz_network)
